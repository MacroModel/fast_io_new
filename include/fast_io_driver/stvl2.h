...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_header_tag(char_type *iter,
																		   stvl2::stvl2_header_tag tg) noexcept
{
...
print_reserve_define_impl_for_stvl2_header_tag_framebuffer(char_type *iter,
														   stvl2::stvl2_header_tag_framebuffer tg) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_header_tag_smp(char_type *iter,
																			   stvl2::stvl2_header_tag_smp tg) noexcept
{
	iter = print_reserve_define_impl_for_stvl2_tag(iter, tg);
	if constexpr (::std::same_as<char_type, char>)
	{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_struct_tag(char_type *iter,
																		   stvl2::stvl2_struct_tag tg) noexcept
{
	...
	if constexpr (::std::same_as<char_type, char>)
	{
		...
		{
		case cmdline_id:
			return copy_string_literal("cmdline_id", iter);
		case memmap_id:
			return copy_string_literal("memmap_id", iter);
		case framebuffer_id:
			return copy_string_literal("framebuffer_id", iter);
		case fb_mtrr_id:
			return copy_string_literal("fb_mtrr_id", iter);
		case modules_id:
			return copy_string_literal("modules_id", iter);
		case rsdp_id:
			return copy_string_literal("rsdp_id", iter);
		case epoch_id:
			return copy_string_literal("epoch_id", iter);
		case firmware_id:
			return copy_string_literal("firmware_id", iter);
		case smp_id:
			return copy_string_literal("smp_id", iter);
		case pxe_server_info:
			return copy_string_literal("pxe_server_info", iter);
		case mmio32_uart:
			return copy_string_literal("mmio32_uart", iter);
		case dtb:
			return copy_string_literal("dtb", iter);
		case vmap:
			return copy_string_literal("vmap", iter);
		default:
			return copy_string_literal("unknown", iter);
		}
	}
	else if constexpr (::std::same_as<char_type, wchar_t>)
	{
		...
		{
		case cmdline_id:
			return copy_string_literal(L"cmdline_id", iter);
		case memmap_id:
			return copy_string_literal(L"memmap_id", iter);
		case framebuffer_id:
			return copy_string_literal(L"framebuffer_id", iter);
		case fb_mtrr_id:
			return copy_string_literal(L"fb_mtrr_id", iter);
		case modules_id:
			return copy_string_literal(L"modules_id", iter);
		case rsdp_id:
			return copy_string_literal(L"rsdp_id", iter);
		case epoch_id:
			return copy_string_literal(L"epoch_id", iter);
		case firmware_id:
			return copy_string_literal(L"firmware_id", iter);
		case smp_id:
			return copy_string_literal(L"smp_id", iter);
		case pxe_server_info:
			return copy_string_literal(L"pxe_server_info", iter);
		case mmio32_uart:
			return copy_string_literal(L"mmio32_uart", iter);
		case dtb:
			return copy_string_literal(L"dtb", iter);
		case vmap:
			return copy_string_literal(L"vmap", iter);
		default:
			return copy_string_literal(L"unknown", iter);
		}
	}
	else if constexpr (::std::same_as<char_type, char16_t>)
	{
		...
		{
		case cmdline_id:
			return copy_string_literal(u"cmdline_id", iter);
		case memmap_id:
			return copy_string_literal(u"memmap_id", iter);
		case framebuffer_id:
			return copy_string_literal(u"framebuffer_id", iter);
		case fb_mtrr_id:
			return copy_string_literal(u"fb_mtrr_id", iter);
		case modules_id:
			return copy_string_literal(u"modules_id", iter);
		case rsdp_id:
			return copy_string_literal(u"rsdp_id", iter);
		case epoch_id:
			return copy_string_literal(u"epoch_id", iter);
		case firmware_id:
			return copy_string_literal(u"firmware_id", iter);
		case smp_id:
			return copy_string_literal(u"smp_id", iter);
		case pxe_server_info:
			return copy_string_literal(u"pxe_server_info", iter);
		case mmio32_uart:
			return copy_string_literal(u"mmio32_uart", iter);
		case dtb:
			return copy_string_literal(u"dtb", iter);
		case vmap:
			return copy_string_literal(u"vmap", iter);
		default:
			return copy_string_literal(u"unknown", iter);
		}
	}
	...
	else
	{
		...
		{
		case cmdline_id:
			return copy_string_literal(u8"cmdline_id", iter);
		case memmap_id:
			return copy_string_literal(u8"memmap_id", iter);
		case framebuffer_id:
			return copy_string_literal(u8"framebuffer_id", iter);
		case fb_mtrr_id:
			return copy_string_literal(u8"fb_mtrr_id", iter);
		case modules_id:
			return copy_string_literal(u8"modules_id", iter);
		case rsdp_id:
			return copy_string_literal(u8"rsdp_id", iter);
		case epoch_id:
			return copy_string_literal(u8"epoch_id", iter);
		case firmware_id:
			return copy_string_literal(u8"firmware_id", iter);
		case smp_id:
			return copy_string_literal(u8"smp_id", iter);
		case pxe_server_info:
			return copy_string_literal(u8"pxe_server_info", iter);
		case mmio32_uart:
			return copy_string_literal(u8"mmio32_uart", iter);
		case dtb:
			return copy_string_literal(u8"dtb", iter);
		case vmap:
			return copy_string_literal(u8"vmap", iter);
		default:
			return copy_string_literal(u8"unknown", iter);
		}
	}
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_mmap_type(char_type *iter,
																		  stvl2::stvl2_mmap_type tg) noexcept
{
	...
	if constexpr (::std::same_as<char_type, char>)
	{
		...
		{
		case usable:
			return copy_string_literal("usable", iter);
		case reserved:
			return copy_string_literal("reserved", iter);
		case acpi_reclaimable:
			return copy_string_literal("acpi_reclaimable", iter);
		case acpi_nvs:
			return copy_string_literal("acpi_nvs", iter);
		case bad_memory:
			return copy_string_literal("bad_memory", iter);
		case bootloader_reclaimable:
			return copy_string_literal("bootloader_reclaimable", iter);
		case kernel_and_modules:
			return copy_string_literal("kernel_and_modules", iter);
		default:
			return copy_string_literal("unknown", iter);
		}
	}
	else if constexpr (::std::same_as<char_type, wchar_t>)
	{
		...
		{
		case usable:
			return copy_string_literal(L"usable", iter);
		case reserved:
			return copy_string_literal(L"reserved", iter);
		case acpi_reclaimable:
			return copy_string_literal(L"acpi_reclaimable", iter);
		case acpi_nvs:
			return copy_string_literal(L"acpi_nvs", iter);
		case bad_memory:
			return copy_string_literal(L"bad_memory", iter);
		case bootloader_reclaimable:
			return copy_string_literal(L"bootloader_reclaimable", iter);
		case kernel_and_modules:
			return copy_string_literal(L"kernel_and_modules", iter);
		default:
			return copy_string_literal(L"unknown", iter);
		}
	}
	else if constexpr (::std::same_as<char_type, char16_t>)
	{
		...
		{
		case usable:
			return copy_string_literal(u"usable", iter);
		case reserved:
			return copy_string_literal(u"reserved", iter);
		case acpi_reclaimable:
			return copy_string_literal(u"acpi_reclaimable", iter);
		case acpi_nvs:
			return copy_string_literal(u"acpi_nvs", iter);
		case bad_memory:
			return copy_string_literal(u"bad_memory", iter);
		case bootloader_reclaimable:
			return copy_string_literal(u"bootloader_reclaimable", iter);
		case kernel_and_modules:
			return copy_string_literal(u"kernel_and_modules", iter);
		default:
			return copy_string_literal(u"unknown", iter);
		}
	}
	...
	else
	{
		...
		{
		case usable:
			return copy_string_literal(u8"usable", iter);
		case reserved:
			return copy_string_literal(u8"reserved", iter);
		case acpi_reclaimable:
			return copy_string_literal(u8"acpi_reclaimable", iter);
		case acpi_nvs:
			return copy_string_literal(u8"acpi_nvs", iter);
		case bad_memory:
			return copy_string_literal(u8"bad_memory", iter);
		case bootloader_reclaimable:
			return copy_string_literal(u8"bootloader_reclaimable", iter);
		case kernel_and_modules:
			return copy_string_literal(u8"kernel_and_modules", iter);
		default:
			return copy_string_literal(u8"unknown", iter);
		}
	}
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_firmware_flags(char_type *iter,
																			   stvl2::stvl2_firmware_flags tg) noexcept
{
	...
	if constexpr (::std::same_as<char_type, char>)
	{
		...
		{
		case bios:
			return copy_string_literal("bios", iter);
		default:
			return copy_string_literal("unknown", iter);
		}
	}
	else if constexpr (::std::same_as<char_type, wchar_t>)
	{
		...
		{
		case bios:
			return copy_string_literal(L"bios", iter);
		default:
			return copy_string_literal(L"unknown", iter);
		}
	}
	else if constexpr (::std::same_as<char_type, char16_t>)
	{
		...
		{
		case bios:
			return copy_string_literal(u"bios", iter);
		default:
			return copy_string_literal(u"unknown", iter);
		}
	}
	...
	else
	{
		...
		{
		case bios:
			return copy_string_literal(u8"bios", iter);
		default:
			return copy_string_literal(u8"unknown", iter);
		}
	}
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_struct(char_type *iter,
																	   stvl2::stvl2_struct const &st) noexcept
{
	if constexpr (::std::same_as<char_type, char>)
	{
...
template <::std::integral char_type>
inline constexpr char_type *
print_reserve_define_impl_for_stvl2_struct_tag_cmdline(char_type *iter, stvl2::stvl2_struct_tag_cmdline st) noexcept
{
...
template <::std::integral char_type, typename T>
	requires(::std::same_as<T, stvl2::stvl2_struct_tag_modules> || ::std::same_as<T, stvl2::stvl2_struct_tag_memmap> ||
			 ::std::same_as<T, stvl2::stvl2_struct_tag_rsdp> || ::std::same_as<T, stvl2::stvl2_struct_tag_epoch> ||
			 ::std::same_as<T, stvl2::stvl2_struct_tag_firmware> ||
			 ::std::same_as<T, stvl2::stvl2_struct_tag_pxe_server_info> ||
			 ::std::same_as<T, stvl2::stvl2_struct_tag_mmio32_uart> || ::std::same_as<T, stvl2::stvl2_struct_vmap> ||
...
inline constexpr char_type *print_reserve_define_impl_for_stvl2_struct_tag_single(char_type *iter, T st) noexcept
{
	...
	else if constexpr (::std::same_as<T, stvl2::stvl2_struct_tag_pxe_server_info>)
	{
		...
		return print_reserve_define(io_reserve_type<char_type, ::std::uint_least32_t>, iter, st.server_ip);
					   ...
					   ::std::same_as<T, stvl2::stvl2_struct_vmap> || ::std::same_as<T, stvl2::stvl2_struct_tag_dtb>)
	{
		if constexpr (::std::same_as<char_type, char>)
		{
			iter = copy_string_literal("\naddr: ", iter);
...
template <::std::integral char_type>
inline constexpr char_type *
print_reserve_define_impl_for_stvl2_struct_tag_framebuffer(char_type *iter,
														   stvl2::stvl2_struct_tag_framebuffer tg) noexcept
{
	iter = print_reserve_define_impl_for_stvl2_tag(iter, tg);
	if constexpr (::std::same_as<char_type, char>)
	{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_mmap_entry(char_type *iter,
																		   stvl2::stvl2_mmap_entry st) noexcept
{
	if constexpr (::std::same_as<char_type, char>)
	{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_smp_info(char_type *iter,
																		 stvl2::stvl2_smp_info st) noexcept
{
	if constexpr (::std::same_as<char_type, char>)
	{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define_impl_for_stvl2_struct_tag_smp(char_type *iter,
																			   stvl2::stvl2_struct_tag_smp st) noexcept
{
	iter = print_reserve_define_impl_for_stvl2_tag(iter, st);
	if constexpr (::std::same_as<char_type, char>)
	{
...
{
	constexpr ::std::size_t number_size{print_reserve_size(io_reserve_type<char_type, stvl2::stvl2_header_tag>) +
...
print_reserve_size(io_reserve_type_t<char_type, stvl2::stvl2_header_tag_framebuffer>) noexcept
{
	...
	{
		return tag_size +
			   details::string_literal_size("\nframebuffer_width: \nframebuffer_height: \nframebuffer_bpp: ");
	}
	else if constexpr (::std::same_as<char_type, wchar_t>)
	{
		return tag_size +
			   details::string_literal_size(L"\nframebuffer_width: \nframebuffer_height: \nframebuffer_bpp: ");
	}
	else
	{
		return tag_size +
			   details::string_literal_size(u8"\nframebuffer_width: \nframebuffer_height: \nframebuffer_bpp: ");
	}
}
...
template <::std::integral char_type>
inline constexpr ::std::size_t
print_reserve_size(io_reserve_type_t<char_type, stvl2::stvl2_struct_tag_cmdline>) noexcept
{
	constexpr ::std::size_t tag_size{print_reserve_size(io_reserve_type<char_type, stvl2::stvl2_tag>) +
									 print_reserve_size(io_reserve_type<char_type, ::std::uint_least64_t>)};
	if constexpr (::std::same_as<char_type, char>)
...
inline constexpr ::std::size_t print_reserve_size(io_reserve_type_t<char_type, T>) noexcept
{
	...
	{
		constexpr ::std::size_t tag_size{tagbase_size +
										 print_reserve_size(io_reserve_type<char_type, ::std::uint_least64_t>)};
	...
	{
		constexpr ::std::size_t tag_size{tagbase_size +
										 print_reserve_size(io_reserve_type<char_type, stvl2::stvl2_firmware_flags>)};
		if constexpr (::std::same_as<char_type, char>)
		{
			return tag_size + details::string_literal_size("\ntag: ");
		}
...
template <::std::integral char_type>
inline constexpr ::std::size_t
print_reserve_size(io_reserve_type_t<char_type, stvl2::stvl2_struct_tag_framebuffer>) noexcept
{
	constexpr ::std::size_t tag_size{print_reserve_size(io_reserve_type<char_type, stvl2::stvl2_tag>) +
...
{
	constexpr ::std::size_t tag_size{print_reserve_size(io_reserve_type<char_type, ::std::size_t>) +
									 print_reserve_size(io_reserve_type<char_type, void const *>) +
...
{
	constexpr ::std::size_t tag_size{print_reserve_size(io_reserve_type<char_type, void const *>) * 3 +
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_tag>, char_type *iter,
												 stvl2::stvl2_tag tg) noexcept
{
	return details::print_reserve_define_impl_for_stvl2_tag(iter, tg);
}

template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_header_tag>, char_type *iter,
												 stvl2::stvl2_header_tag hd) noexcept
{
	return details::print_reserve_define_impl_for_stvl2_header_tag(iter, hd);
}

template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_header>, char_type *iter,
												 stvl2::stvl2_header hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_header_tag_framebuffer>,
												 char_type *iter, stvl2::stvl2_header_tag_framebuffer hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_header_tag_smp>,
												 char_type *iter, stvl2::stvl2_header_tag_smp hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_struct_tag>, char_type *iter,
												 stvl2::stvl2_struct_tag hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_struct>, char_type *iter,
												 stvl2::stvl2_struct const &hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_struct_tag_cmdline>,
												 char_type *iter, stvl2::stvl2_struct_tag_cmdline hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_struct_tag_framebuffer>,
												 char_type *iter, stvl2::stvl2_struct_tag_framebuffer hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_mmap_type>, char_type *iter,
												 stvl2::stvl2_mmap_type hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_firmware_flags>,
												 char_type *iter, stvl2::stvl2_firmware_flags hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_module>, char_type *iter,
												 stvl2::stvl2_module hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_mmap_entry>, char_type *iter,
												 stvl2::stvl2_mmap_entry hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_smp_info>, Iter iter,
												 stvl2::stvl2_smp_info hd) noexcept
{
...
template <::std::integral char_type>
inline constexpr char_type *print_reserve_define(io_reserve_type_t<char_type, stvl2::stvl2_struct_tag_smp>,
												 char_type *iter, stvl2::stvl2_struct_tag_smp hd) noexcept
{
