...
using static_iso_argument =
	decltype(::fast_io::fmt::static_arg<leap_day>());
using static_timestamp_argument =
	decltype(::fast_io::fmt::static_arg<leap_day_timestamp>());
using named_static_iso_argument =
	decltype(::fast_io::fmt::static_arg<"when", leap_day>());
using positive_offset_argument =
	decltype(::fast_io::fmt::static_arg<positive_offset>());
using negative_offset_argument =
	decltype(::fast_io::fmt::static_arg<negative_second_offset>());
using iso_week_one_boundary_argument =
	decltype(::fast_io::fmt::static_arg<iso_week_one_boundary>());
using previous_iso_year_boundary_argument =
	decltype(::fast_io::fmt::static_arg<previous_iso_year_boundary>());
...
[[nodiscard]] bool all_character_domains_match_dynamic()
{
	auto const narrow_static{
		::fast_io::fmt::concat_std<narrow_format>(
			::fast_io::fmt::static_arg<leap_day>())};
...
[[nodiscard]] bool timestamp_and_named_paths_match_dynamic()
{
	...
	auto const offsets_static{
		::fast_io::fmt::concat_std<offset_format>(
			::fast_io::fmt::static_arg<positive_offset>(),
			::fast_io::fmt::static_arg<negative_second_offset>())};
	...
	auto const iso_week_boundaries_static{
		::fast_io::fmt::concat_std<iso_week_boundary_format>(
			::fast_io::fmt::static_arg<iso_week_one_boundary>(),
			::fast_io::fmt::static_arg<previous_iso_year_boundary>())};
